...
/// The Albums tab, showing user-made albums and smart albums.
///
/// Device folders have their own tab now, so they are not shown here.
/// The FAB creates a new album, and long-pressing a user album opens the
/// album menu (rename, pin, delete).
